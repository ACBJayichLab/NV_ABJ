...
class NationalInstrumentsDaqSingleAxisScannerConfiguration:
    """
    device_name_input:str = Device name that the voltage input is attached to e.g. "PXI1Slot3"
    device_name_output:str = Device name for the out put
    channel_name_input:str = Name for the channel input e.g. "ai0"
    ...
    conversion_volts_per_meter:float
...
class NationalInstrumentsDaqSingleAxisScanner(ScannerSingleAxis):
    ...
    def get_position_m(self):
        ...
        return voltage/self._device_configuration.conversion_volts_per_meter
    ...
    def position_to_voltage(self,position):
        ...
        voltage_set = self._device_configuration.conversion_volts_per_meter*position
    ...
    def wait_for_voltage(self,voltage):
        try:
            ...
            try:
                ...
                with nidaqmx.Task() as task:
                    task.ai_channels.add_ai_voltage_chan(self.daq_class_input.id_daq_channel, terminal_config=nidaqmx.constants.TerminalConfiguration.RSE)
            ...
            raise Exception("Failed to stabalize voltage output")
